...
export const REMOVE_APPLICATION_START = "@applications/remove application start";
export const REMOVE_APPLICATION_SUCCESS = "@applications/remove application success";
export const REMOVE_APPLICATION_ERROR = "@applications/remove application error";